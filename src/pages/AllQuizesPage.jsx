  ...
  return (
    <div>
        ...
        <div className='grid grid-cols-4 mx-90 mt-85 ' id='allQuizes'>
          ...
          <div className='flex items-center justify-center cursor-pointer' onClick={()=>{navigate('/catagoty/general')}}>

            <img src={general} alt="" srcset="" className='absolute w-70 h-60 rounded-4xl shadow-2xl  hover:opacity-50 hover:shadow-blue-500 hover:w-75 hover:h-65' />
          ...
          <div className='flex items-center justify-center cursor-pointer'>
            ...
            <img src={science} alt="" srcset="" className='absolute w-70 h-60 rounded-4xl cursor-pointer  hover:opacity-50  shadow-2xl hover:shadow-blue-500  hover:w-75 hover:h-65' />
          ...
          <div className='flex items-center justify-center cursor-pointer'>
            ...
            <img src={maths} alt="" srcset="" className='absolute w-70 h-60 rounded-4xl cursor-pointer  hover:opacity-50  shadow-2xl hover:shadow-blue-500  hover:w-75 hover:h-65' />
          ...
          <div className='flex items-center justify-center cursor-pointer'>
            ...
            <img src={it} alt="" srcset="" className='absolute w-70 h-60 rounded-4xl cursor-pointer  hover:opacity-50  shadow-2xl hover:shadow-blue-500  hover:w-75 hover:h-65' />
          ...
          <div className='flex items-center justify-center mt-45 cursor-pointer'>
            ...
            <img src={litarature} alt="" srcset="" className='absolute w-70 h-60 rounded-4xl cursor-pointer  hover:opacity-50  shadow-2xl hover:shadow-blue-500  hover:w-75 hover:h-65' />
          ...
          <div className='flex items-center justify-center mt-45 cursor-pointer'>
            ...
            <img src={history} alt="" srcset="" className='absolute w-70 h-60 rounded-4xl cursor-pointer  hover:opacity-50  shadow-2xl hover:shadow-blue-500  hover:w-75 hover:h-65' />
          ...
          <div className='flex items-center justify-center mt-45 cursor-pointer'>
            ...
            <img src={media} alt="" srcset="" className='absolute w-70 h-60 rounded-4xl cursor-pointer  hover:opacity-50  shadow-2xl hover:shadow-blue-500  hover:w-75 hover:h-65' />
          ...
          <div className='flex items-center justify-center mt-45 cursor-pointer'>
            ...
            <img src={sports} alt="" srcset="" className='absolute w-70 h-60 rounded-4xl cursor-pointer  hover:opacity-50  shadow-2xl hover:shadow-blue-500  hover:w-75 hover:h-65' />
